...
public class PageMaker {
	private int totalCount;	//endPage를 계산하기 위해서 전체 게시글 개수가 필요
	...
	private int displayPageNum;	//페이지네이션의 페이지 개수
	...
	public void calcData() {
		...
		endPage = (int) (Math.ceil(criteria.getPage()/(double) displayPageNum)*displayPageNum);	//endPage = 40;
		
		startPage = (endPage - displayPageNum)+1;	//startPage = 31;
