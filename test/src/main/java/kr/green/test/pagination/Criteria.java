...
public class Criteria {
	...
	private String search;	//input 창에 검색하는 값
	
	
	public Criteria() {	//Criteria 디폴트 생성자 : 현재 페이지를 1페이지로, 한 페이지에 10개의 컨텐츠
		this.page = 1;
		this.perPageNum = 10;
		this.type = 0;
		this.search = "";
	...
	public void setPerPageNum(int perPageNum) {
		/* 한 페이지에 컨텐츠 수를 0이상 100이하로 설정 개발자 설정에 따라 100부분을 수정할 수 있음 */
